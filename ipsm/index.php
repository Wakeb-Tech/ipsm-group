...
ob_start();
 $conn =  require "assets/php/dbConnection.php";
    ...
    $prows = $con->prepare("SELECT YEAR FROM position GROUP BY YEAR");
    $prows->execute();
    $precord = $prows->fetchAll();
		...
		<div class="charts-content">
			<div class="charts-area">
				...
				<div class="chart1">
					...
					<div class="angry-chart">
						<p>Angry</p>
						<div class="chart-data">
							<div class="chart-body angry-body">
								<canvas id="angryData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
	
					<div class="disgust-chart">
						<p>Disgust</p>
						<div class="chart-data">
							<div class="chart-body disgust-body">
								<canvas id="disgustData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
	
					<div class="happy-chart">
						<p>Happy</p>
						<div class="chart-data">
							<div class="chart-body happy-body">
								<canvas id="happyData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
	
					<div class="neutral-chart">
						<p>Neutral</p>
						<div class="chart-data">
							<div class="chart-body neutral-body">
								<canvas id="neutralData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
					...
					<div class="sad-chart">
						<p>Sad</p>
						<div class="chart-data">
							<div class="chart-body sad-body">
								<canvas id="sadData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
	
					<div class="surprise-chart">
						<p>Surprise</p>
						<div class="chart-data">
							<div class="chart-body surprise-body">
								<canvas id="surpriseData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
					...
					<div class="fear-chart">
						<p>Fear</p>
						<div class="chart-data">
							<div class="chart-body fear-body">
								<canvas id="fearData"></canvas>
							</div>
						</div>
						<span>0%</span>
					</div>
				...
				<div class="chart3">
					...
					<div style="margin-right: -58px" class="controls">
	
						<div class="radio-section">
							<div class="ch3 radio-btn" id="ch3_y_btn">
								<input type="radio" name="ch43ime" value="y">
								<span>Year</span>
							</div>

							<div class="ch3 radio-btn" id="ch3_mo_btn">
								<input type="radio" name="ch43ime" value="mo">
								<span>Monthly</span>
							</div>
							<div class="ch3 radio-btn" id="ch3_we_btn">
								<input type="radio" name="ch43ime" value="we">
								<span>Weekly</span>
							</div>
							<div class="ch3 radio-btn" id="ch3_da_btn">
								<input type="radio" name="ch43ime" value="da">
								<span>Daily</span>
							</div>
						</div>
						...
						<div class="combo-section">
							...
							<select class="disabled" id="ch3_mo">
							...
							<select class="disabled" id="ch3_we">
							...
							<select class="disabled" id="ch3_da">
			...
			<section class="chart5">
				<div class="inner-section">
					<h1>The overal percentage of emotions</h1>
					<div class="controls">
	
						<div class="radio-section">
							<div class="ch5 radio-btn" id="ch5_y_btn">
								<input type="radio" name="ch5Time" value="y">
								<span>Year</span>
							</div>

							<div class="ch5 radio-btn" id="ch5_mo_btn">
								<input type="radio" name="ch5Time" value="mo">
								<span>Month</span>
							</div>
							<div class="ch5 radio-btn" id="ch5_we_btn">
								<input type="radio" name="ch5Time" value="we">
								<span>Week</span>
							</div>
							<div class="ch5 radio-btn" id="ch5_da_btn">
								<input type="radio" name="ch5Time" value="da">
								<span>Day</span>
							</div>
						</div>
						...
						<div class="combo-section">
							...
							<select class="disabled" id="ch5_mo">
								<option value="all">All Months</option>
								<option value="1">January</option>
								<option value="2">February</option>
								<option value="3">March</option>
							...
							<select class="disabled" id="ch5_we">
								<option value="all">All Weeks</option>
								<option value="1">Week 1</option>
								<option value="2">Week 2</option>
								<option value="3">Week 3</option>
							...
							<select class="disabled" id="ch5_da">
								<option value="all">All Days</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
			...
			<section class="chart6">
				<div class="inner-section">
					...
					<div class="controls">
						...
						<div class="radio-section">
							<div class="ch6 radio-btn" id="ch6_mo_btn">
								<input type="radio" name="ch6Time" value="mo">
								<span>Year</span>
							</div>
							...
							<div class="ch6 radio-btn" id="ch6_we_btn">
								<input type="radio" name="ch6Time" value="we">
								<span>Week</span>
							</div>
							<div class="ch6 radio-btn" id="ch6_da_btn">
								<input type="radio" name="ch6Time" value="da">
								<span>Day</span>
							</div>
						</div>
	
						<div class="combo-section">
							<select class="" id="ch6_y">
								<option value="none">None</option>
								<option value="all">All Years</option>
								
								<?php
									 if ($precord > 0) {
									    foreach ($precord as $year) {
										  echo '<option value="'.$year[0].'">'.$year[0].'</option>';
									    }
							...
							<select class="disabled" id="ch6_mo">
								<option value="all">All Months</option>
								<option value="1">January</option>
								<option value="2">February</option>
								<option value="3">March</option>
							...
							<select class="disabled" id="ch6_we">
								<option value="all">All Weeks</option>
								<option value="1">Week 1</option>
								<option value="2">Week 2</option>
								<option value="3">Week 3</option>
							...
							<select class="disabled" id="ch6_da">
								<option value="all">All Days</option>
								<option value="1">1</option>
								<option value="2">2</option>
								<option value="3">3</option>
					...
					<div class="chart6-body" style="height: 618px !important;">
						<div   id="heatmapContainerWrapper" class="chart6-data">
      					<div  id="heatmapContainer">
						
						   <img  width="1276"   src = "assets/images/out.jpg"/>
				...
				<div class="hero-inner row">
					<div class="col-lg-6 col-md-7">
						<div class="hero-content">
							...
							<h1>Rased</h1>
							<p>An application in machine vision techniques which monitoring the feelings and number of the audience through their interaction with an event.</p>
							<ul>
								<li>
